...
class RawSDLWindow : public Window {
private:
	SDL_Window *window;

public:
	RawSDLWindow(const char *name = "SDL Window", const Window::Size &size = Window::Size(800,600), unsigned int flags = 0)
		: Window(size)
	{
